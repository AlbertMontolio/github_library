165_MUST_required_changes_to_cloud_function_code.md
...
Replace YOUR_PROJECT_ID  with, well, your Firebase project id. Also make sure to replace the VAPID details in the code with the ones generated by you.

Run npm install --save busboy  inside the functions/  folder (i.e. cd functions  first).

You can now also uninstall formidable (npm uninstall --save formidable).
